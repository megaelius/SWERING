...
for (i in 1:k){
    ...
    acum_error0 = acum_error0 + Error(as.numeric(yvalidation),prediction0,nrow(xvalidation))
    ...
    acum_error1 = acum_error1 + Error(as.numeric(yvalidation),prediction1,nrow(xvalidation))
}
